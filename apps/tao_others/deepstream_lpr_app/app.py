...
ALPR_START_GRACE_SECONDS = max(15, int(os.getenv("ALPR_START_GRACE_SECONDS", "180")))
        ...
        merged_sources.append(
            {
                ...
                "preview_sequence": runtime_item.get("preview_sequence"),
                ...
                "last_latency_event": runtime_item.get("last_latency_event"),
                "last_latency_utc": runtime_item.get("last_latency_utc"),
                "last_latency_frames_from_first_read": runtime_item.get("last_latency_frames_from_first_read"),
                "last_latency_ms_from_first_read": runtime_item.get("last_latency_ms_from_first_read"),
                "last_latency_frames_from_readable": runtime_item.get("last_latency_frames_from_readable"),
                "last_latency_ms_from_readable": runtime_item.get("last_latency_ms_from_readable"),
                **v4l2_state,
            }
        )
...
async def get_camera_config() -> dict:
    ...
    return {
        ...
        "low_latency_rtsp": runtime_status.get("low_latency_rtsp"),
        "rtsp_latency_ms": runtime_status.get("rtsp_latency_ms"),
        "rtsp_drop_on_latency": runtime_status.get("rtsp_drop_on_latency"),
        "rtsp_protocols": runtime_status.get("rtsp_protocols"),
        "latency_metrics": runtime_status.get("latency_metrics"),
